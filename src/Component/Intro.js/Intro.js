  ...
  return (
        <div >
          ...
          <div className='about'>
              ...
              <p className='aboutText'>Currently I'm an aspiring web-developer fresh out of fullstack bootcamp. I've always had a fixation for unravaling technical issues, so it comes natural for me to pursue a career coding. Currently seeking a team to help develop my skills, while creating amazing websites. Is your team the one I seek? </p>
              </div>
              </div>  
              </div></div></div>
